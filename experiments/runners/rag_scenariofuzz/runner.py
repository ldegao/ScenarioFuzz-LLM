#!/usr/bin/env python3
"""
Unified runner for RAG-ScenarioFuzz experiments.
...
Example usage:
  ...
  python -m experiments.runners.run_rag_scenariofuzz --num-scenarios 100

  # Timed: 2 hours
  python -m experiments.runners.run_rag_scenariofuzz --hours 2
"""
...
def build_parser() -> argparse.ArgumentParser:
    """Create CLI argument parser for RAG-ScenarioFuzz."""
    parser = argparse.ArgumentParser(
        description="Run RAG-ScenarioFuzz experiments (quantitative or timed)",
...
def main() -> None:
    """Main entry point for RAG-ScenarioFuzz experiments."""
    parser = build_parser()
